        ...
        <div className="w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div 
                ...
                className="black-gradient m-7 w-20 h-20 rounded-full flex justify-center items-center cursor-pointer"
            >
              <img 
                src={github}
                alt="github"
    ...
    <>
      ...
      <div className="w-full flex">
          ...
          >
            ...
            with links to the live demos and code repositories. This section 
